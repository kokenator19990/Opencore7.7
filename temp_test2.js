const qnaDB = [
  ...
  { q: "¿Hay un mínimo de proyecto?", a: "En casos específicos podemos iniciar desde aproximadamente 30 UF, previa evaluación de viabilidad." },
  ...
  { q: "¿Cuánto cuesta al mes?", a: "El mínimo mensual recomendado para desarrollo eficiente es ~30 UF. Este nivel cubre horas de ingeniería activa y seguimiento sostenido. Proyectos más complejos o con mayor asignación de recursos tienen retainer mensual superior, definido en propuesta formal." },
  { q: "¿Cobran mensualmente?", a: "Sí. Para proyectos en curso trabajamos con retainer mensual mínimo de ~30 UF, recomendado para mantener ritmo eficiente. El monto varía según complejidad y equipo asignado. También trabajamos por hitos o bolsa de horas según el caso." },
  { q: "¿El mínimo de 30 UF es mensual?", a: "Sí. Los ~30 UF corresponden al mínimo mensual recomendado para el desarrollo eficiente de un proyecto. Este nivel permite asignación de recursos consistente y avance real. Proyectos más complejos lo superan según alcance y recursos." },
  { q: "¿Los valores son mensuales o por proyecto?", a: "Depende del modelo acordado: retainer mensual (mínimo ~30 UF/mes recomendado), proyecto cerrado (precio total definido tras diagnóstico) o bolsa de horas. El modelo más adecuado se define según la naturaleza del proyecto." },
  { q: "¿Las tarifas son anuales?", a: "El esquema anual se negocia caso a caso según tamaño del proyecto, complejidad, recursos asignados y magnitud de la solución. No existe tarifa anual fija. El mínimo mensual recomendado es ~30 UF, y los proyectos anuales se estructuran a partir de esa base." },
  { q: "¿Cuánto es el mínimo mensual?", a: "El mínimo mensual recomendado es de aproximadamente 30 UF. Este nivel permite asignación de recursos consistente y desarrollo eficiente. Para proyectos más complejos o con mayor necesidad de recursos, el retainer se define en propuesta formal." },
  { q: "¿Pago mensual o por hito?", a: "Ambas modalidades son posibles. El pago mensual (retainer ~30 UF mínimo) es ideal para proyectos continuos; el pago por hitos es preferido en proyectos cerrados con entregables definidos. La modalidad se decide al formalizar el contrato." },
  ...
  { q: "¿Aceptan proyectos pequeños?", a: "Sí, siempre que el proyecto sea viable y tenga sentido técnico-económico. De forma excepcional pueden tomarse desde alrededor de 30 UF, normalmente en modalidad acotada por horas y con objetivos claros." },
  ...
  { q: "¿Cuál es el precio mínimo para empezar?", a: "Normalmente evaluamos proyectos desde aproximadamente 30 UF en adelante, dependiendo del alcance y viabilidad." },
  { q: "¿Trabajan con empresas pequeñas?", a: "Sí, evaluando estrictamente la viabilidad técnica y económica conjunta. Podemos asumir proyectos desde un mínimo de ~30 UF para casos específicos de integración o rescate arquitectónico de pymes en escalamiento." },
  ...
  { q: "¿Cuánto vale un proyecto mínimo?", a: "En casos acotados podemos comenzar desde aproximadamente 30 UF, aunque nuestro foco natural son proyectos de mayor escala." },
  ...
  { q: "Quiero automatizar mi empresa", a: "¡Es el momento perfecto! Reducir tareas manuales repetitivas baja sus costos fijos y disminuye a casi cero los errores humanos. Lo integramos todo por API." },
  { q: "Quiero confiar en ustedes", a: "Puede hacerlo plenamente. Somos ingenieros dedicados a rescatar, modernizar y mantener software corporativo operando ininterrumpidamente bajo contratos claros." },
  ...
  { q: "Quiero un proyecto de 10 UF", a: "Agradecemos su interés. Por el nivel de ingeniería Senior involucrado, garantizamos SLAs sobre proyectos que tipifican desde las 30 UF. Sugerimos soluciones SaaS estándar para presupuestos menores." },
  ...
  { q: "¿Qué pasa si pierdo mis datos?", a: "Implementamos estrategias de backup según criticidad del sistema. Ante pérdida de datos, ejecutamos recuperación desde el respaldo más reciente con mínimo impacto operacional. Para datos críticos recomendamos backups automáticos con retención definida contractualmente." },
  { q: "¿Qué pasa si la migración falla?", a: "Todas nuestras migraciones incluyen plan de reversa: podemos volver al estado anterior si algo no sale bien. Las migraciones se ejecutan por etapas con validaciones previas para minimizar este riesgo. La probabilidad de fallo se reduce al mínimo con diagnóstico riguroso previo." },
  { q: "¿Qué pasa si hay un error crítico después de la entrega?", a: "Cubrimos errores post-entrega según el SLA de soporte contratado. Distinguimos entre bugs del alcance original (cubiertos sin costo) y nuevos requerimientos (se gestionan como cambios). La cobertura exacta, plazo y condiciones se definen en contrato." },
  { q: "¿Cómo manejan incidentes de seguridad?", a: "Con protocolo formal: detección, contención, análisis, remediación y reporte post-incidente. Para sistemas críticos se define previamente: tiempos de respuesta, responsables y canales de comunicación en el contrato de soporte. Todo bajo NDA." },
  { q: "¿Qué pasa si el sistema se cae en horario crítico?", a: "En contratos de soporte crítico respondemos en 30-60 minutos. Se activa protocolo de emergencia con diagnóstico, comunicación al cliente y contención del impacto. Para sistemas 24/7 diseñamos redundancia y failover para reducir el riesgo de caída total." },
  { q: "¿Tienen garantía si algo sale mal?", a: "Los entregables tienen período de garantía correctiva definido contractualmente. Los errores del alcance comprometido se corrigen sin costo adicional en ese período. Esto se especifica claramente en el contrato para evitar ambigüedades." },
  { q: "¿Qué pasa si el proveedor cloud tiene problemas?", a: "Diseñamos arquitecturas con tolerancia a fallos del proveedor. Para sistemas críticos implementamos multi-región, failover automático o plan de recuperación ante desastres (DR) para minimizar el impacto de una caída del proveedor." },
  { q: "¿Cómo responden ante una brecha de datos?", a: "Protocolo de crisis: aislamiento del sistema afectado, análisis forense, notificación al cliente, remediación y reporte. Operamos bajo NDA y cumplimos obligaciones legales de notificación cuando aplica según la ley de datos personales en Chile." },
  { q: "¿Protegen mis sistemas contra ransomware?", a: "Implementamos capas de defensa: backups aislados y probados, control de accesos, hardening de servidores y monitoreo de actividad anómala. El ransomware no es completamente prevenible, pero el daño se minimiza con backups verificados y respuesta rápida." },
  { q: "¿Qué pasa si hay un desastre natural o corte prolongado?", a: "Para sistemas críticos diseñamos planes de recuperación ante desastres (DR): infraestructura en cloud con múltiples zonas de disponibilidad, replicación de datos y procedimientos de failover para mantener operación ante escenarios extremos." },
  { q: "¿Tienen plan de continuidad del negocio?", a: "Sí. Para sistemas críticos diseñamos BCP/DR como parte del contrato: define qué ocurre ante distintos escenarios de fallo, quién toma decisiones, cómo se restaura el servicio y en qué tiempo máximo. Es parte de nuestro estándar enterprise." },
  { q: "¿Cómo previenen ataques DDoS?", a: "Implementamos protección a nivel de infraestructura: CDN, WAF (Web Application Firewall), rate limiting y servicios de mitigación DDoS según criticidad del sistema y presupuesto del cliente. La estrategia se define en la arquitectura inicial." },
  { q: "¿Qué pasa si el desarrollador asignado se va?", a: "La continuidad está garantizada por la gobernanza del proyecto: documentación técnica, control de versiones y equipo de respaldo. OpenCORE funciona como equipo, no como individuo. La pérdida de un recurso no detiene ni pone en riesgo el proyecto del cliente." },
  { q: "¿Tienen backups automáticos?", a: "Sí. Implementamos estrategias de backup automatizado según criticidad: diario, por hora o en tiempo real con retención definida. Los backups se prueban periódicamente para garantizar recuperación real, no solo almacenamiento." },
  { q: "¿Qué pasa si hay un bug grave en producción?", a: "Activamos soporte de emergencia según SLA: diagnóstico, fix urgente, prueba en staging y despliegue controlado. Si el fix tarda, evaluamos contención temporal (rollback, modo degradado) para proteger la operación hasta resolver la causa raíz." },
  { q: "¿Cómo actualizan sistemas sin interrumpir el servicio?", a: "Usamos estrategias de despliegue controlado: blue-green deployment, canary releases o ventanas de mantenimiento minimizadas. Para sistemas 24/7 diseñamos actualizaciones sin downtime o con ventanas de minutos programadas." },
  ...
  { q: "¿Son intuitivas sus plataformas?", a: "Diseñamos soluciones con enfoque funcional y claridad operativa. La usabilidad es parte estructural del desarrollo, no un agregado posterior." },
  { q: "¿Son realmente buenas?", a: "Nuestros proyectos están orientados a resolver problemas estructurales, no superficiales. La calidad se mide por estabilidad, continuidad y resultados sostenibles." },
  { q: "¿Pero funcionan de verdad?", a: "Sí. Trabajamos principalmente en entornos donde la continuidad operacional es crítica, por lo que cada implementación es validada técnicamente antes de su despliegue." },
  { q: "No quiero algo experimental, ¿ustedes son serios?", a: "Nuestra firma tiene enfoque conservador y estructural. No implementamos soluciones experimentales en entornos empresariales críticos." },
  { q: "¿Tienen experiencia real o solo teoría?", a: "Nuestra experiencia proviene de proyectos ejecutados en empresas con operaciones activas y sistemas complejos en funcionamiento." },
  { q: "¿Qué los diferencia de otras empresas?", a: "Nuestra especialidad es intervenir sistemas existentes complejos y estabilizarlos estructuralmente, no solo desarrollar desde cero." },
  { q: "¿Son caros?", a: "El valor depende del alcance y complejidad. Nuestra propuesta está alineada con consultoría tecnológica senior, no con desarrollo básico." },
  { q: "¿Son económicos?", a: "Más que económicos, buscamos que la inversión sea proporcional al impacto estructural y operativo que generamos." },
  { q: "No entiendo bien qué hacen…", a: "Nos especializamos en modernizar, integrar y estabilizar sistemas empresariales para que operen de forma eficiente y sostenible." },
  { q: "¿Pueden trabajar con lo que ya tengo?", a: "Sí. Gran parte de nuestro trabajo consiste en integrar o mejorar arquitecturas ya existentes sin necesidad de reemplazo total." },
  { q: "¿Reemplazan sistemas antiguos?", a: "Podemos modernizarlos progresivamente o rediseñar su arquitectura según evaluación técnica." },
  { q: "¿Y si mi sistema es muy complejo?", a: "Precisamente trabajamos con entornos complejos. Nuestro enfoque es estructural y progresivo." },
  { q: "No quiero cambiar todo…", a: "No es necesario. Muchas veces implementamos mejoras modulares sin alterar completamente la operación actual." },
  { q: "¿Trabajan con empresas pequeñas?", a: "Sí, siempre que exista una necesidad tecnológica estructural clara y un compromiso de mejora progresiva." },
  { q: "¿Solo trabajan con empresas grandes?", a: "Nuestra especialidad está en entornos medianos y grandes, pero evaluamos cada caso según su complejidad." },
  { q: "¿Son rápidos?", a: "Priorizamos precisión sobre velocidad. Sin embargo, trabajamos con cronogramas definidos y metodologías estructuradas." },
  { q: "¿Cuánto se demoran en responder?", a: "Mantenemos tiempos de respuesta acordes a estándares profesionales y compromisos contractuales." },
  { q: "No quiero algo que falle…", a: "La estabilidad es uno de nuestros pilares. Diseñamos soluciones robustas antes que soluciones apresuradas." },
  { q: "¿Qué pasa si el proyecto falla?", a: "Nuestra metodología incluye validaciones progresivas para minimizar riesgos antes de cualquier despliegue completo." },
  { q: "¿Tienen garantía?", a: "Todos los proyectos se formalizan contractualmente y contemplan etapas de validación y soporte." },
  { q: "¿Pueden mejorar lo que tengo sin romperlo?", a: "Sí. Trabajamos con intervención controlada y arquitectura modular." },
  { q: "No quiero depender siempre de ustedes…", a: "Diseñamos sistemas documentados y sostenibles, evitando dependencias innecesarias." },
  { q: "¿Son confiables?", a: "Nuestra trayectoria y enfoque estructural están orientados precisamente a generar confianza operativa." },
  { q: "¿Tienen respaldo técnico real?", a: "Sí. Nuestro equipo combina dirección ejecutiva con desarrollo técnico de alto nivel." },
  { q: "¿Y si mi equipo interno no coopera?", a: "Podemos trabajar como oficina técnica complementaria o arquitectos externos según sea necesario." },
  { q: "¿Trabajan bajo contrato formal?", a: "Sí, siempre operamos bajo acuerdos formales y definidos." },
  { q: "¿Hacen mantenimiento también?", a: "Sí, bajo modalidad mensual desde 30 UF, sujeto a evaluación." },
  { q: "No sé si mi empresa está lista…", a: "Podemos realizar un diagnóstico inicial para determinar nivel de madurez tecnológica." },
  { q: "¿Son innovadores?", a: "Implementamos innovación cuando aporta valor estructural, no como tendencia pasajera." },
  { q: "¿Trabajan con ERP específicos?", a: "Evaluamos cada ERP según su arquitectura y posibilidades de integración." },
  { q: "¿Pueden integrar múltiples sistemas?", a: "Sí, diseñamos interoperabilidad controlada entre plataformas empresariales." },
  { q: "¿Son muy técnicos?", a: "Somos técnicamente sólidos, pero traducimos soluciones a lenguaje de negocio." },
  { q: "No quiero que mi operación se detenga…", a: "Planificamos migraciones progresivas para evitar interrupciones críticas." },
  { q: "¿Trabajan remoto?", a: "Sí, según requerimiento y naturaleza del proyecto." },
  { q: "¿Trabajan presencial?", a: "Cuando la criticidad lo requiere, sí." },
  { q: "¿Son flexibles?", a: "Adaptamos soluciones, no principios estructurales." },
  { q: "¿Son estrictos?", a: "En arquitectura crítica, sí." },
  { q: "¿Pueden escalar el sistema?", a: "Diseñamos pensando en crecimiento futuro." },
  { q: "¿Qué tan seguros son sus desarrollos?", a: "Aplicamos prácticas de seguridad estructural." },
  { q: "¿Cumplen normativas?", a: "Trabajamos bajo estándares empresariales." },
  { q: "¿Documentan lo que hacen?", a: "Sí, es parte esencial del proceso." },
  { q: "¿Hacen auditorías técnicas?", a: "Sí, como parte del diagnóstico." },
  { q: "¿Pueden reducir costos operativos?", a: "Frecuentemente, mediante optimización estructural." },
  { q: "¿Me ayudarán a ordenar mi sistema?", a: "Ese es uno de nuestros principales enfoques." },
  { q: "¿Trabajan por etapas?", a: "Sí, implementación progresiva." },
  { q: "¿Pueden integrarse con mi contabilidad?", a: "Sí, mediante arquitectura multimoneda e integración contable." },
  { q: "¿Son transparentes con precios?", a: "Siempre sujetos a evaluación formal." },
  { q: "¿Hacen acompañamiento estratégico?", a: "Sí, bajo modalidad mensual desde 30 UF." },
  { q: "¿Pueden trabajar con bases grandes?", a: "Sí, optimizamos rendimiento backend." },
  { q: "¿Trabajan con datos sensibles?", a: "Sí, bajo protocolos de confidencialidad." },
  { q: "¿Hacen planificación tecnológica?", a: "Sí, definimos roadmap estratégico." },
  { q: "¿Pueden rescatar un proyecto fallido?", a: "Es una de nuestras especialidades." },
  { q: "¿Son especialistas o generalistas?", a: "Somos especialistas en arquitectura empresarial." },
  { q: "¿Trabajan con automatización?", a: "Sí, procesos administrativos y financieros." },
  { q: "¿Se adaptan a nuestro presupuesto?", a: "Evaluamos alcance para estructurar propuesta viable." },
  { q: "¿Son solo desarrolladores?", a: "Somos consultoría estratégica con ejecución técnica." },
  { q: "¿Qué pasa después del proyecto?", a: "Podemos ofrecer continuidad operacional." },
  { q: "¿Me conviene trabajar con ustedes?", a: "Depende del nivel estructural de su necesidad tecnológica." },
  { q: "¿Por qué debería confiar en ustedes y no en otra empresa?", a: "La confianza se construye con experiencia verificable y enfoque estructural. Nuestra trayectoria en entornos críticos respalda nuestra metodología." },
  { q: "¿Me garantizan que no habrá errores?", a: "Ningún sistema complejo está exento de ajustes, pero minimizamos riesgos mediante validaciones técnicas progresivas." },
  { q: "¿Son mejores que [empresa grande]?", a: "Cada firma tiene su enfoque. Nosotros nos especializamos en arquitectura estructural y modernización de sistemas complejos." },
  { q: "¿Cuántos clientes tienen exactamente?", a: "Operamos bajo confidencialidad contractual, por lo que no divulgamos cifras específicas públicamente." },
  { q: "Dígame un cliente importante que tengan.", a: "Por política de confidencialidad, no revelamos nombres sin autorización formal." },
  { q: "¿Si fallo con ustedes quién responde?", a: "Todos los proyectos se formalizan contractualmente con responsabilidades definidas y etapas de validación." },
  { q: "¿Pueden hacer lo mismo que SAP o Oracle?", a: "No somos un proveedor de software masivo; somos consultoría estratégica que integra y optimiza soluciones empresariales." },
  { q: "¿Son solo intermediarios?", a: "No. Diseñamos y ejecutamos arquitectura tecnológica directamente." },
  { q: "¿Cuánto dinero han facturado este año?", a: "Esa información es interna. Nuestro enfoque está en la calidad técnica de cada proyecto." },
  { q: "¿Qué pasa si no quedo satisfecho?", a: "Trabajamos con hitos de validación progresivos para asegurar alineación antes de cada fase crítica." },
  { q: "¿Pueden hacerlo más barato que la competencia?", a: "Evaluamos alcance y complejidad antes de estimar valores. La prioridad es sostenibilidad, no reducción artificial de costos." },
  { q: "¿Son una empresa pequeña?", a: "Somos una firma especializada, con enfoque senior y estructura ejecutiva definida." },
  { q: "¿Y si desaparecen mañana?", a: "Trabajamos con documentación técnica estructurada y contratos formales que resguardan continuidad." },
  { q: "¿Pueden trabajar gratis para probar?", a: "Realizamos diagnósticos preliminares, pero la ejecución técnica profesional requiere formalización contractual." },
  { q: "¿Prometen resultados?", a: "Prometemos metodología estructurada y ejecución profesional. Los resultados dependen también del entorno operativo del cliente." },
  { q: "¿Pueden duplicar mi productividad en un mes?", a: "La mejora estructural es progresiva y medible; evitamos promesas irreales." },
  { q: "¿Son los mejores del mercado?", a: "Nos posicionamos como especialistas en arquitectura empresarial y modernización estructural." },
  { q: "¿Cuántos desarrolladores tienen?", a: "Operamos con estructura estratégica y técnica flexible según requerimiento del proyecto." },
  { q: "¿Trabajan 24/7?", a: "Definimos disponibilidad según modalidad contractual y criticidad del sistema." },
  { q: "¿Qué pasa si mi equipo no colabora?", a: "Podemos actuar como oficina técnica externa con autonomía operativa definida." },
  { q: "¿Han tenido proyectos que fracasaron?", a: "Todo entorno tecnológico presenta desafíos; nuestra metodología busca minimizar y corregir oportunamente cualquier desviación." },
  { q: "¿Qué los hace diferentes realmente?", a: "Nuestro foco está en intervenir arquitecturas existentes complejas y estabilizarlas estructuralmente." },
  { q: "¿Son demasiado técnicos para mi empresa?", a: "Traducimos arquitectura compleja en soluciones operativas comprensibles para dirección ejecutiva." },
  { q: "¿Me pueden asegurar ROI?", a: "El retorno depende de múltiples variables operativas; diseñamos soluciones orientadas a eficiencia estructural." },
  { q: "¿Pueden hackear sistemas?", a: "No realizamos actividades fuera del marco legal ni ético. Nuestra labor es arquitectura y modernización empresarial." },
  { q: "¿Son solo consultores que hablan mucho?", a: "Nuestra consultoría incluye ejecución técnica concreta." },
  { q: "¿Pueden hacerlo todo?", a: "Nos enfocamos en lo que dominamos: arquitectura empresarial y modernización estructural." },
  { q: "¿Y si el proyecto se extiende más de lo previsto?", a: "Definimos alcance formal y gestión de cambios para evitar desviaciones descontroladas." },
  { q: "¿Pueden copiar el sistema de otra empresa?", a: "Diseñamos soluciones adaptadas, no replicamos arquitecturas sin evaluación." },
  { q: "¿Ustedes hacen IA también?", a: "Evaluamos integración de inteligencia artificial cuando aporta valor estructural real." },
  { q: "¿Pueden darme acceso total a su código?", a: "La propiedad intelectual y condiciones se definen contractualmente." },
  { q: "¿Cuánto ganan ustedes por proyecto?", a: "Esa información es interna; lo relevante es el valor estructural entregado." },
  { q: "¿Pueden trabajar sin contrato?", a: "No. Toda intervención profesional requiere formalización." },
  { q: "¿Pueden garantizar cero interrupciones?", a: "Planificamos migraciones progresivas para minimizar impacto operativo." },
  { q: "¿Son una startup?", a: "Somos una consultora con más de 15 años de trayectoria." },
  { q: "¿Qué pasa si no entiendo lo técnico?", a: "Traducimos cada etapa a impacto operativo y financiero." },
  { q: "¿Son muy caros para Chile?", a: "Nuestros valores están alineados a consultoría tecnológica senior." },
  { q: "¿Pueden trabajar con presupuesto limitado?", a: "Podemos estructurar fases progresivas según alcance." },
  { q: "¿Prometen seguridad absoluta?", a: "Implementamos buenas prácticas de seguridad estructural, aunque ningún sistema es absolutamente invulnerable." },
  { q: "¿Me pueden hacer algo rápido en una semana?", a: "Depende del alcance técnico; evaluamos antes de comprometer plazos." },
  { q: "¿Qué pasa si cambio de opinión?", a: "El alcance y condiciones se establecen formalmente antes de iniciar ejecución." },
  { q: "¿Son solo dos personas?", a: "El liderazgo es ejecutivo, y la ejecución se estructura según complejidad del proyecto." },
  { q: "¿Pueden competir con grandes multinacionales?", a: "Nuestra especialización nos permite intervenir con foco y profundidad en arquitectura empresarial." },
  { q: "¿Me pueden hacer descuento especial?", a: "Evaluamos propuestas según alcance y modalidad contractual." },
  { q: "¿Qué tan seguros son sus servidores?", a: "Aplicamos prácticas estándar de seguridad según arquitectura definida." },
  { q: "¿Pueden mentir para cerrar trato?", a: "Nuestra política es transparencia técnica y contractual." },
  { q: "¿Me pueden prometer que no necesitaré más inversión?", a: "La evolución tecnológica requiere planificación progresiva." },
  { q: "¿Son mejores que freelancers?", a: "Operamos con enfoque estructural, contractual y de arquitectura empresarial." },
  { q: "¿Pueden hacer lo mismo más rápido que todos?", a: "Priorizamos precisión y estabilidad antes que velocidad apresurada." },
  { q: "¿Qué pasa si quiero cancelar?", a: "Las condiciones contractuales establecen escenarios de término anticipado." },
  { q: "¿Tienen respaldo financiero?", a: "Operamos bajo estructura empresarial formal y contratos definidos." },
  { q: "¿Son realmente expertos o solo dicen eso?", a: "Nuestra experiencia está basada en ejecución de proyectos reales en entornos operativos." },
  { q: "¿Pueden improvisar si algo sale mal?", a: "Actuamos bajo metodología estructurada, no improvisación." },
  { q: "¿Son demasiado formales?", a: "La formalidad es parte de la seguridad operativa en entornos críticos." },
  { q: "¿Me pueden garantizar que será el mejor sistema que exista?", a: "Garantizamos adecuación estructural a su necesidad, no comparaciones absolutas." },
  { q: "¿Pueden hacer algo que nadie más pueda hacer?", a: "Nos especializamos en modernización estructural y rescate tecnológico complejo." },
  { q: "¿Son solo marketing?", a: "Nuestra base es técnica y contractual, no publicitaria." },
  { q: "¿Qué pasa si la tecnología cambia?", a: "Diseñamos arquitecturas escalables y adaptables a evolución tecnológica." },
  { q: "¿Pueden trabajar sin documentación?", a: "La documentación es parte obligatoria de nuestra metodología." },
  { q: "¿Y si quiero probarlos solo para ver qué hacen?", a: "Podemos realizar un diagnóstico exploratorio para definir alcance real." },
  { q: "¿Cuántas personas trabajan en OpenCORE?", a: "OpenCORE está liderado por ejecutivos con experiencia en tecnología y negocio. Contamos con un núcleo estable de entre 5 y 10 profesionales, ampliable según el proyecto." },
  { q: "¿Son una empresa pequeña?", a: "Somos una firma especializada con estructura ejecutiva definida y equipo técnico estable. Nuestra capacidad se dimensiona según la complejidad del proyecto." },
  { q: "¿Cuántos profesionales tiene el equipo técnico?", a: "Mantenemos un equipo base permanente y ampliamos capacidades hasta 20 o 30 profesionales según alcance y tipo de cliente." },
  { q: "¿Cómo está conformado su equipo?", a: "Nuestro equipo combina liderazgo ejecutivo, arquitectura tecnológica, desarrollo técnico e integración empresarial." },
  { q: "¿Tienen experiencia real en su equipo?", a: "Sí. El equipo está compuesto por profesionales con experiencia en modernización tecnológica y proyectos empresariales críticos." },
  { q: "¿El equipo es fijo o variable?", a: "Contamos con un núcleo estable y una red ampliable que se activa según los requerimientos técnicos del proyecto." },
  { q: "¿Pueden manejar proyectos grandes con ese equipo?", a: "Sí. Nuestra estructura es escalable y se ajusta proporcionalmente a la complejidad y extensión del proyecto." },
  { q: "¿Son solo unos pocos profesionales?", a: "Tenemos un núcleo técnico consolidado y la capacidad de escalar con especialistas adicionales cuando el proyecto lo requiere." },
  { q: "¿Trabajan con personal interno o externo?", a: "Operamos con un equipo base permanente y especialistas adicionales coordinados bajo dirección técnica centralizada." },
  { q: "¿Cuántos desarrolladores tienen actualmente?", a: "El número varía según proyecto activo. La estructura se adapta dinámicamente al alcance técnico definido." },
  { q: "¿Qué tipo de perfiles conforman el equipo?", a: "Trabajamos con arquitectos de software, desarrolladores senior, especialistas en bases de datos e integración empresarial." },
  { q: "¿Tienen ingenieros especializados?", a: "Sí. El equipo incluye profesionales con trayectoria en entornos tecnológicos empresariales complejos." },
  { q: "¿Pueden aumentar el equipo si el proyecto crece?", a: "Sí. Nuestra estructura permite escalar de manera controlada según el tipo de intervención requerida." },
  { q: "¿Cómo aseguran calidad si el equipo varía?", a: "La dirección ejecutiva y técnica centraliza la supervisión, asegurando estándares homogéneos en cada fase." },
  { q: "¿Cuántos años de experiencia tiene el equipo?", a: "El liderazgo y el equipo técnico acumulan más de 15 años de experiencia en consultoría tecnológica empresarial." },
  { q: "¿El equipo trabaja tiempo completo en los proyectos?", a: "El núcleo principal sí. Los recursos adicionales se asignan según criticidad y cronograma." },
  ...
  { q: "¿Pueden trabajar con mi equipo técnico interno?", a: "Sí. Colaboramos con equipos internos en modalidad de refuerzo técnico, co-desarrollo o como líderes técnicos externos, según la dinámica y necesidades del proyecto." },
  { q: "¿Cuántos proyectos llevan simultáneamente?", a: "Manejamos varios proyectos en paralelo con asignación de recursos por proyecto. El núcleo activo permite hasta 10 consultores simultáneos, complementados con especialistas asociados cuando el proyecto lo requiere." },
  { q: "¿Tienen capacidad para proyectos urgentes?", a: "Sí, evaluamos disponibilidad. Para urgencias críticas reforzamos equipo y ajustamos prioridades. La disponibilidad urgente puede implicar recargo según criticidad y complejidad del requerimiento." },
  { q: "¿Qué pasa si quiero pausar el proyecto?", a: "Se puede acordar contractualmente. La pausa implica revisar hitos, estado del avance y condiciones de reanudación. Se gestiona con transparencia para proteger la inversión realizada hasta ese punto." },
  { q: "¿Cómo aseguran continuidad si OpenCORE tuviera problemas internos?", a: "La continuidad del cliente está protegida por entrega de código fuente, documentación técnica y know-how transferido. El cliente no depende de OpenCORE para operar su sistema: esa es nuestra filosofía desde el inicio del proyecto." },
  { q: "¿Pueden terminar proyectos de forma anticipada?", a: "Sí. Las condiciones de término anticipado se definen contractualmente. Entregamos el estado del avance, documentación y código hasta ese punto, protegiendo la inversión realizada." },
  { q: "¿Hacen proyectos llave en mano?", a: "Sí. Podemos entregar proyectos llave en mano: desde diseño de arquitectura hasta puesta en marcha, capacitación del equipo cliente y soporte inicial post-lanzamiento." },
  { q: "¿Pueden encargarse de toda la infraestructura?", a: "Sí, en modalidad completa gestionamos desde arquitectura hasta despliegue en cloud, incluyendo monitoreo, backups y operación inicial del sistema." },
  { q: "¿Trabajan con dólares?", a: "Trabajamos principalmente en UF o pesos chilenos. Para proyectos con clientes fuera de Chile evaluamos la moneda según el acuerdo comercial." },
  { q: "¿Tienen descuentos por proyectos grandes?", a: "El modelo de precios se adapta según volumen y duración. Proyectos de mayor escala o compromisos de largo plazo pueden negociar condiciones específicas en la propuesta formal." },
  { q: "¿Cuánto dura el proceso de diagnóstico?", a: "La reunión exploratoria inicial toma 15-30 minutos. Un diagnóstico técnico formal puede durar de 1 día a 2 semanas según complejidad del sistema. El objetivo es dimensionar riesgo y esfuerzo real antes de comprometer inversión." },
  { q: "¿Puedo contratar por horas puntuales?", a: "Sí. Ofrecemos modalidad por hora o por bolsa de horas, útil para intervenciones puntuales o soporte específico. El valor hora va de 1 a 5 UF según especialización requerida." },
  { q: "¿Hacen proyectos para emprendedores?", a: "Sí, cuando el proyecto tiene solidez técnica y económica real. El mínimo de ~30 UF mensuales es el piso recomendado para asegurar avance eficiente. Evaluamos cada caso con honestidad para recomendar el camino más conveniente." },
  ...
  { q: "Hola, ¿Hay un mínimo de proyecto?", a: "En casos específicos podemos iniciar desde aproximadamente 30 UF, previa evaluación de viabilidad." },
  { q: "Hola, ¿Cuánto cuesta el mantenimiento anual?", a: "El mantenimiento se estructura según criticidad y evolución requerida. Generalmente entre 5% y 30% del valor del proyecto como referencia. Para proyectos en curso trabajamos con retainer mensual mínimo de ~30 UF, ajustado según recursos y complejidad." },
  { q: "Hola, ¿Los precios son mensuales o anuales?", a: "Trabajamos con modelos flexibles. El mínimo recomendado para desarrollo activo es ~30 UF mensuales. El esquema anual no tiene tarifa fija: se negocia caso a caso según tamaño del proyecto, complejidad, recursos asignados y magnitud de la solución." },
  { q: "Hola, ¿Cuánto cuesta al mes?", a: "El mínimo mensual recomendado para desarrollo eficiente es ~30 UF. Este nivel cubre horas de ingeniería activa y seguimiento sostenido. Proyectos más complejos o con mayor asignación de recursos tienen retainer mensual superior, definido en propuesta formal." },
  { q: "Hola, ¿Los valores son mensuales o por proyecto?", a: "Depende del modelo acordado: retainer mensual (mínimo ~30 UF/mes recomendado), proyecto cerrado (precio total definido tras diagnóstico) o bolsa de horas. El modelo más adecuado se define según la naturaleza del proyecto." },
  { q: "Hola, ¿Qué pasa si el proyecto se atrasa?", a: "Se gestiona bajo marco contractual con mecanismos de replanificación." },
  { q: "Hola, ¿Pueden trabajar offline en proyectos críticos?", a: "Sí, cuando la criticidad lo exige." },
  { q: "Hola, ¿Pueden salvar un proyecto fallido?", a: "Si es técnicamente viable, sí; primero evaluamos el estado real del sistema." },
  { q: "Hola, ¿Qué tecnología usan?", a: "Seleccionamos tecnología según estrategia del cliente, no por moda." },
  { q: "Hola, ¿Cuánto dura un proyecto típico?", a: "Desde semanas hasta meses, según complejidad." },
  { q: "Hola, ¿Por qué elegir OpenCORE?", a: "Porque modernizamos sin poner en riesgo la operación." },
  { q: "Hola, ¿Para qué sirves?", a: "Soy el primer punto de contacto inteligente de OpenCORE. Oriento sobre servicios, precios, metodología y experiencia, y puedo derivarte a un especialista humano." },
  { q: "Hola, ¿En qué año se fundó formalmente OpenCORE?", a: "OpenCORE se constituyó formalmente como empresa en 2015. La trayectoria del equipo se remonta a 1998, trabajando en tecnología empresarial bajo otras denominaciones y proyectos previos." },
  { q: "Hola, ¿Cuántos años de experiencia tiene OpenCORE?", a: "Contamos con trayectoria operativa en sistemas corporativos desde 1998, constituidos formalmente en 2015. Sumamos décadas de experiencia conjunta estabilizando, integrando y escalando arquitecturas complejas." },
  { q: "Hola, ¿Cuál es la capacidad del equipo en proyectos grandes?", a: "En proyectos grandes asignamos hasta 10 consultores simultáneos del núcleo activo, complementados con especialistas asociados si el alcance lo requiere. Se estructura con roles y responsables para asegurar continuidad y control." },
  { q: "Hola, ¿En qué se diferencia OpenCORE de una empresa de desarrollo 'tradicional'?", a: "No somos fábrica de código; somos consultoría senior orientada a continuidad y resultados de negocio. Partimos por diagnóstico, definimos riesgos, priorizamos hitos y diseñamos una solución sostenible, no solo 'funcional'." },
  { q: "Hola, ¿Cuántos proyectos ha realizado OpenCORE?", a: "Hemos ejecutado aproximadamente 120 a 150 proyectos, de los cuales al menos 30 han sido de gran escala. La experiencia incluye construcción, integración, migración y operación de sistemas críticos." },
  { q: "Hola, ¿Con qué empresas han trabajado?", a: "El equipo cuenta con experiencia en proyectos y entregables en entornos corporativos asociados a empresas como Finning, Caterpillar, Nestlé, Komatsu y Cocha, entre otras. Por política, el detalle público se valida caso a caso según autorización." },
  { q: "Hola, ¿Qué servicios ofrece OpenCORE?", a: "Consultoría tecnológica, modernización de sistemas legacy, migración a cloud, integración de plataformas, desarrollo a medida, auditoría técnica y soporte operativo. El servicio se adapta por industria, criticidad y madurez tecnológica del cliente." },
  { q: "Hola, ¿Pueden tomar proyectos donde no existe documentación?", a: "Sí, pero primero hacemos discovery para evaluar viabilidad y costo real. Si el costo de entender o corregir es desproporcionado, lo comunicamos con transparencia y proponemos alternativas realistas." },
  { q: "Hola, ¿Pueden rescatar proyectos fallidos de otras consultoras?", a: "Sí. Evaluamos el estado del código, arquitectura, datos y riesgos; luego definimos un plan de estabilización. En algunos casos es más eficiente refactorizar por módulos; en otros, reconstruir con migración controlada." },
  { q: "Hola, ¿Cómo cobra OpenCORE sus servicios?", a: "Trabajamos por hora, por bolsa de horas, por proyecto cerrado o por servicio mensual con SLA. Elegimos el modelo según incertidumbre, criticidad y necesidad de control de alcance." },
  { q: "Hola, ¿Cuál es el ticket típico de proyectos?", a: "En general, proyectos medianos a grandes suelen estar entre 300 y 500 UF o más, dependiendo del alcance. La estimación final se define tras diagnóstico y levantamiento de requerimientos." },
  { q: "Hola, ¿Aceptan proyectos pequeños?", a: "Sí, siempre que el proyecto sea viable y tenga sentido técnico-económico. De forma excepcional pueden tomarse desde alrededor de 30 UF, normalmente en modalidad acotada por horas y con objetivos claros." },
  { q: "Hola, ¿Cuánto cuesta desarrollar un sistema de inventario para una ferretería pequeña?", a: "Depende de integración y personalización. Un inventario básico puede partir en rangos del orden de 80–200 UF, mientras que un sistema integrado (inventario + facturación + reportes) suele moverse en rangos superiores, definido tras diagnóstico." },
  { q: "Hola, ¿Qué pasa si el proyecto requiere más horas de las estimadas?", a: "Se activa el mecanismo contractual: se informa el impacto, se presenta alternativa y se acuerda el camino antes de ejecutar. La idea es que el cliente tenga control real de presupuesto y decisiones." },
  { q: "Hola, ¿Qué pasa si el cliente cambia requerimientos a mitad del proyecto?", a: "Se evalúa el cambio y su impacto en costo y plazo, y se formaliza vía contrato (adenda). Trabajamos con flexibilidad, pero cuidando el orden: un proyecto sin control de cambios termina costando más y entregando menos." },
  { q: "Hola, ¿OpenCORE puede actuar como partner estratégico y no solo proveedor?", a: "Por supuesto. Se evalúa el mejor modelo según el proyecto: proveedor, partner tecnológico, alianza o servicio continuo. Lo importante es que el esquema maximice valor, reduzca riesgo y sostenga la operación del cliente." },
  { q: "Hola, ¿El cliente queda como dueño del sistema desarrollado?", a: "Por supuesto. La propiedad y derechos quedan establecidos en contrato; en modalidad estándar de desarrollo externo, el cliente puede quedar como propietario del entregable completo." },
  { q: "Hola, ¿Qué hacen para evitar fallas en producción?", a: "Trabajamos con ambientes de prueba, staging y despliegue controlado. En migraciones críticas se diseñan planes de reversa, monitoreo y ventanas de cambio cuidadosamente definidas." },
  { q: "Hola, ¿Qué tipo de tecnologías manejan?", a: "Trabajamos con tecnologías empresariales modernas y legacy, según el escenario. La selección tecnológica se define por continuidad operacional, mantenibilidad, costo total y compatibilidad con el ecosistema del cliente." },
  { q: "Hola, ¿OpenCORE se vende como 'empresa de IA'?", a: "Nos posicionamos como consultoría tecnológica que integra IA como complemento, cuando aporta valor real. No promovemos 'IA por moda'; priorizamos estabilidad, seguridad, continuidad y retorno operacional." },
  { q: "Hola, ¿Ofrecen soporte después de entregar el proyecto?", a: "Sí. Ofrecemos soporte correctivo y evolutivo, con modalidades mensuales o por bolsas de horas. En sistemas críticos se puede contratar soporte 24/7 con SLA y tiempos de respuesta acordados." },
  { q: "Hola, ¿Cuánto cuesta el mantenimiento anual de un sistema?", a: "Como referencia, puede estar entre 5% y 30% del valor del proyecto, según criticidad, frecuencia de cambios y dependencias externas. Se define en base a necesidades reales del cliente, no por fórmula rígida." },
  { q: "Hola, ¿Qué pasa si un desarrollador clave deja el proyecto?", a: "Tenemos equipo constituido y continuidad operativa del proyecto; además, la documentación y gobernanza reducen dependencia de una sola persona. En escenarios extremos, se aplican mecanismos contractuales para proteger al cliente." },
  { q: "Hola, ¿Qué pasa si el proyecto no cumple lo comprometido?", a: "Se activa el marco contractual: se revisan entregables, aceptación y se aplican correcciones o medidas acordadas. Nuestro enfoque es evitar llegar a ese punto mediante diagnóstico realista, hitos y validación temprana." },
  { q: "Hola, ¿Me puedes ayudar con mi proyecto?", a: "Por supuesto. Cuéntame qué necesitas y te orientaré sobre viabilidad, costos aproximados y próximos pasos." },
  { q: "Hola, ¿Cuál es el precio mínimo para empezar?", a: "Normalmente evaluamos proyectos desde aproximadamente 30 UF en adelante, dependiendo del alcance y viabilidad." },
  { q: "Hola, ¿Valen lo que cobran?", a: "Cuando el sistema no se cae y la operación sigue facturando, generalmente la respuesta es sí." },
  { q: "Hola, ¿Pueden trabajar como socios tecnológicos?", a: "Sí. Evaluamos el modelo más adecuado: proveedor, partner estratégico o alianza técnica." },
  { q: "Hola, ¿Por qué debería hablar con OpenCORE?", a: "Porque modernizar sistemas sin poner en riesgo la operación no es algo que todas las consultoras sepan hacer correctamente." },
  { q: "Hola, ¿Cuánto cobran?", a: "Trabajamos en rangos referenciales entre 1 y 5 UF por hora, según complejidad. Proyectos típicos medianos y grandes suelen estar entre 300 y 500 UF o más, definidos tras diagnóstico." },
  { q: "Hola, ¿Cuánto vale un proyecto mínimo?", a: "En casos acotados podemos comenzar desde aproximadamente 30 UF, aunque nuestro foco natural son proyectos de mayor escala." },
  { q: "Hola, ¿Cómo cobran?", a: "Podemos trabajar por hora, bolsa de horas, proyecto cerrado o servicio mensual con SLA. El modelo se define según incertidumbre y criticidad." },
];
...
const synonyms = {
  ...
  "proyecto": ["trabajo", "desarrollo", "implementacion"],
...
function saveLead(tipo, dato) {
  try {
    ...
    leads.push({ tipo, dato, fecha: new Date().toISOString(), pagina: window.location.href });
    localStorage.setItem('oc_leads', JSON.stringify(leads));
    console.log('[OpenCORE Lead] Guardado localmente:', { tipo, dato });
  } catch (e) { }
...
function runAudioTests() {
    ...
    for (const q of ["Hola que ofrecen","Hola que tienen","Hola que productos tienen a la venta","Hola que servicios tienen disponibles","Hola quiero hacer un proyecto","Hola me gustaria trabajar con ustedes","Hola son caros","Hola que ofrecen que tienen que productos tienen a la venta quiero hacer un proyecto","hola que servicios tienen disponibles me gustaria saber si son muy caros y ver si puedo hacer algo con ustedes","hola me gustaria trabajar con ustedes quiero hacer un proyecto super grande que necesito saber que me ofrecen"]) {
