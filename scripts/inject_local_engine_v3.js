...
const targetFile = path.resolve(__dirname, '../v3/js/chatbot.js');
...
console.log('Successfully patched V3 chatbot.js to remove Gemini and lower fuzzy matching thresholds.');
